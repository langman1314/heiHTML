...
export const phase5Protagonist = [
  ...
  },
  {
    ...
    content: `
      ...
      <h3>拒绝的理由：三堵墙</h3>
      <div class=\"grid-3\">
        <div class=\"card\"><h3 class=\"card-title\">第一堵 · 认知墙</h3><div class=\"card-body\">裂视让他能够看见神胎的底层结构——也因此能看见成神的真相：那不是飞升，而是被神胎当作"最适合统合碎片的人格"，被安装进一个比你大无数倍的系统里。他不是拒绝力量，他是识破了诱饵。裂视越深越清楚：成神不是"我获得一切"，而是"我被神胎获得"。</div></div>

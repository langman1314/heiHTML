// 无光域·上一轮外来者遗产档案（Phase 3.2 深化）
// 任务书 3.2 回复：他们不是传说，而是玩家未来可能失败成的样子

export const phase3Legacy = [
  {
    id: 'legacy-overview',
    num: 'L1',
    title: '上一轮外来者总论',
    sub: '当前穿越不是第一次，系统不是第一次运行筛选',
    summary: '上一轮外来者是当前全民穿越之前被神胎拖入的另一批外部文明，来自高度依赖光源、门路、梦境存储与排名秩序的复合文明。他们分化为旧灯、旧门、旧梦、旧榜四大路线，最终全部失败——每一类失败都已成为无光域当前结构的一部分。',
    content: `
      <p class="section-desc">上一轮外来者的遗产不是单纯遗迹，而是无光域当前结构的一部分：旧灯残页来自他们的光稳定实验，叠室遗迹来自他们的门路逃离工程，梦腐层来自他们的文明存档计划，排行榜残留来自他们的成神候选实验。当前系统也吸取了上一轮经验，变得更像游戏、更会诱导、更懂得分阶段保护与筛选。</p>
      <h3>四类失败路线</h3>
      <div class="grid-2">
